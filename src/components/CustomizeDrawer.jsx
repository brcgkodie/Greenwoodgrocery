...
export default function CustomizeDrawer({ sandwich, onClose, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center" onClick={onClose}>
      ...
      <div
        className="relative bg-cream w-full sm:max-w-lg sm:rounded-2xl rounded-t-3xl max-h-[92vh] overflow-y-auto border border-forest/10"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Image */}
        {s.img && (
          <div className="aspect-[16/9] overflow-hidden sm:rounded-t-2xl rounded-t-3xl">
